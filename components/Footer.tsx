export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-olive to-olive-dark text-white py-16 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="font-elegant text-xl md:text-2xl italic mb-8 text-emerald-light leading-relaxed">
          &quot;El amor es paciente, el amor es bondadoso. No envidia, no es jactancioso, no se
          enorgullece.&quot;
        </p>

        <p className="font-elegant text-lg text-white/80 mb-8">1 Corintios 13:4</p>
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center items-center font-elegant text-white/90">
            <a
              href="mailto:contacto@boda-yasminmanu.com"
