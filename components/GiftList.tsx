    ...
    <section className="relative z-10 py-20 px-4 mt-20">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          >
            <svg
              className="w-32 h-32 md:w-36 md:h-36 text-gold group-hover:text-gold-light transition-colors animate-gift-bounce group-hover:animate-gift-pulse"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <p
          className="font-elegant text-xl md:text-2xl leading-relaxed mt-10 text-center"
          style={{ color: '#FAF8F3' }}
        >
          El mejor presente es compartir este dia con nosotros pero si deseas agasajarnos en este
          momento tan especial podes hacerlo apretando el REGALO.
        </p>
      </div>
    </section>
  );
